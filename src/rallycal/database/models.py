...
class CalendarSourceModel(Base):
    ...
    # Filtering
    filter_keywords: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
    ...
    last_sync_success: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
...
class EventModel(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("source_id", "original_uid", name="uq_events_source_original_uid"),
    )
